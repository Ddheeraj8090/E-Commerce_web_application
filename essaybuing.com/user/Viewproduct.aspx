<%@ Page Title="" Language="C#" MasterPageFile="~/user/usermaster.Master" AutoEventWireup="true" CodeBehind="Viewproduct.aspx.cs" Inherits="essaybuing.com.user.Viewproduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server"><section>
            <div class="section">
              <%--  <div class="section1">
                ...
                <div class="section2">
                    <div class="container">
                        <div class="items">
                            ...
                            <div class="name"><asp:Button ID="btnshoe" runat="server" CommandArgument="p1" Text="SHOES" OnClick="btnshoe_Click" /> </div>
